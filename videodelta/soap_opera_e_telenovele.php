...
<html lang="it">
	<head>
		...
		<title>VIDEODELTA - Soap opera/telenovele</title>
			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown active"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Crediti<span class="caret"></span></a>
					<ul class="dropdown-menu">
						...
						<li class="active"><a href="#">Soap opera/Telenovele<span class="sr-only">(current)</span></a></li>
		...
		<div class="row">
			<div class="col-md-12">
				<ol class="breadcrumb">
					...
					<li class="active">Soap opera/telenovele</li>
				</ol>
				<h1 class="page-header">Soap opera/telenovele</h1>
			</div>
			<div class="col-md-8">
				
				<?php include_once ("query_soap_opera_e_telenovele.php"); ?>
