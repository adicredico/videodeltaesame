...
<html lang="it">
	<head>
		...
		<title>VIDEODELTA - Cartoni animati</title>
		...
		<div class="row">
			<div class="col-md-12">
				<ol class="breadcrumb">
					...
					<li class="active">Cartoni animati</li>
				</ol>
				<h1 class="page-header">Cartoni animati</h1>
			</div>
			<div class="col-md-9">
				
				<?php include_once ("query_cartoni_animati.php"); ?>
