				...
				<div class="container-fluid">
      				<div class="row">
						...
						<div class="col-md-6" style="text-align:center;">
							<a href="javascript:void(0)"><img class="img-thumbnail lazy" src="images/loghi/media.jpg" alt="" style="display:block"></a>
							<button type="button" class="btn-btn-info" data-toggle="collapse" data-target="#demo1">More info</button>
							<div id="demo1" class="collapse">Mediaset S.p.A. è un'azienda privata italiana attiva nell'ambito dei media e della comunicazione. È specializzata primariamente in produzione e distribuzione televisiva in libera visione (free to air, FTA) e a pagamento (pay-tv e pay per view) su più piattaforme, oltre che in produzione e distribuzione cinematografica, multimediale e in raccolta pubblicitaria.
						...
						<div class="col-md-6" style="text-align:center;">
         					<a href="javascript:void(0)"><img class="img-thumbnail lazy" src="images/loghi/disney1.jpg" alt="" style="display:block"></a>
							<button type="button" class="btn-btn-info" data-toggle="collapse" data-target="#demo2">More info</button>
							<div id="demo2" class="collapse">La Walt Disney Company, comunemente conosciuta come Disney, è una multinazionale statunitense attiva nel settore mediatico e dell'intrattenimento con sede a Burbank, nello Stato della California.
       					...
       					<div class="col-md-6" style="text-align:center;">
         					<a href="javascript:void(0)"><img class="img-thumbnail lazy" src="images/loghi/netflix.jpg" alt="" style="display:block"></a>
							<button type="button" class="btn-btn-info" data-toggle="collapse" data-target="#demo3">More info</button>
                            <div id="demo3" class="collapse">Netflix è un'azienda operante nella distribuzione via internet di film, serie televisive e altri contenuti d'intrattenimento.
        				...
        				<div class="col-md-6" style="text-align:center;">
       					...
       					<div class="col-md-6" style="text-align:center;">
         					<a href="javascript:void(0)"><img class="img-thumbnail lazy" src="images/loghi/redeglobo.jpg" alt="" style="display:block"></a>
							<button type="button" class="btn-btn-info" data-toggle="collapse" data-target="#demo10">More info</button>
                            <div id="demo10" class="collapse">Rede Globo (o Rede Globo de Televisão, nota anche come TV Globo o semplicemente Globo) è una rete televisiva brasiliana le cui trasmissioni iniziarono a Rio de Janeiro, il 26 aprile 1965.
